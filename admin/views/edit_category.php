<style>
    ...
    .btn-submit { width: 100%; padding: 12px; background: #10b981; color: white; border: none; border-radius: 6px; font-size: 16px; font-weight: bold; cursor: pointer; transition: 0.3s; }
...
<div class="form-container">
    ...
    <form method="POST" action="">
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" value="<?= htmlspecialchars($cat['name']) ?>" onkeyup="ChangeToSlug();" required>
        </div>

        <div class="form-group">
            <label>Slug (Đường dẫn)</label>
            <input type="text" name="slug" id="slug" value="<?= htmlspecialchars($cat['slug']) ?>">
        </div>
        ...
        <a href="?page=categorys" class="btn-back">Hủy bỏ</a>
    </form>
</div>
